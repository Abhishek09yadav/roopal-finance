    ...
    <>
      ...
      <ul>
        <li>
          ...
          reprocessed and reused, reducing landfill waste.
        </li>
        <li>
          <strong>Bio-Based Alternatives:</strong> Exploring materials derived
          from renewable sources to lower environmental impact.
        </li>
        <li>
          <strong>Lightweight Packaging:</strong> Reducing material usage
          without compromising durability.
        </li>
      </ul>
      Our state-of-the-art manufacturing facilities are designed to optimize
      energy consumption. By adopting energy-efficient equipment and green
      technology like solar-powered systems, we minimize power usage and reduce
      emissions.
    </>
  ),
  desc_4: (
    <>
      ...
      <ul>
        <li>
          <strong>Environmental Impact:</strong> Reduces pollution and conserves
          natural resources.
        </li>
        <li>
          <strong>Brand Value:</strong> Companies adopting eco-friendly
          practices gain trust and loyalty.
        </li>
        <li>
          <strong>Regulatory Compliance:</strong> Aligns with evolving
