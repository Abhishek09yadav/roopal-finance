...
const blog_details_content: ContentType = {
  title_1:
    "Custom Blow & Injection Molded Plastic Solutions: Precision Meets Innovation",
  ...
  desc_2: (
    <>
      <strong>Why Choose Custom Blow & Injection Molding?</strong>
      <br />
      <ul>
        <li>
          <strong>Tailored to Your Needs:</strong> Our custom solutions cater to
          diverse industry requirements, ensuring each product is designed to
          perfection.
        </li>
        <li>
          <strong>Enhanced Durability:</strong> Products are engineered to
          withstand various environmental conditions, ensuring long-lasting
          performance.
        </li>
        <li>
          <strong>Cost-Efficiency:</strong> Our streamlined manufacturing
          processes deliver high-quality products at competitive prices.
        </li>
      </ul>
    </>
  ),
  desc_3: (
    <>
      ...
      <ul>
        <li>
          <strong>Diverse Applications:</strong> From liquid to powder
          packaging, our products are ideal for a range of industries including
          pharmaceuticals, FMCG, and chemicals.
        </li>
        <li>
          <strong>Advanced Technology:</strong> Leveraging state-of-the-art blow
          and injection molding techniques, we create products with superior
          strength and precision.
        </li>
        <li>
          <strong>End-to-End Support:</strong> Our team collaborates with
          clients at every step, from product design and development to final
          delivery.
        </li>
      </ul>
    </>
