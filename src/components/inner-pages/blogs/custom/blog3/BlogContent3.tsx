...
const blog_details_content: ContentType = {
  ...
  desc_2: (
    <>
      ...
      <ul>
        <li>
          <strong>Product Integrity:</strong> Ensuring that medicines remain
          uncontaminated and effective throughout their shelf life.
        </li>
        <li>
          <strong>Accurate Dosing:</strong> Precision in measuring liquid or
          powdered medications to avoid under or overdosing.
        </li>
        <li>
          <strong>Regulatory Compliance:</strong> Adhering to strict standards
          set by global health authorities for packaging.
        </li>
      </ul>
    </>
  ),
    ...
    <>
      ...
      <ul>
        <li>
          ...
          to prevent spills or contamination, ensuring the integrity of liquid
          medications.
        </li>
        <li>
          <strong>Accurate Measuring Cups:</strong> Created with precision to
          enable exact dosing, simplifying usage for both healthcare
          professionals and patients.
        </li>
        <li>
          <strong>Tamper-Evident Closures:</strong> Providing clear evidence of
          any interference, these closures enhance product safety and build
          consumer trust.
        </li>
      </ul>
    </>
    ...
    <>
      ...
      <ul>
        <li>
          ...
          high-quality materials that meet pharmaceutical-grade standards.
        </li>
        <li>
          <strong>Customized Solutions:</strong> From unique designs to specific
          functional features, we cater to the diverse needs of the
          pharmaceutical industry.
        </li>
        <li>
          <strong>Commitment to Excellence:</strong> Each product undergoes
          rigorous testing to ensure compliance and reliability.
        </li>
      </ul>
      <p>
